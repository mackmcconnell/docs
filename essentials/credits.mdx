...
After running a query in the Web Interface, you can stop the query prior to execution. At this point your query will also stop spending credits and you will have only spent what the query required until you stopped the query.
